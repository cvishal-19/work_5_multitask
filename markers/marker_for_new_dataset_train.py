...
splits=['test']
for split in splits:
    json_filename = f"/Users/kovid/Desktop/kovid/updated_aaec_para_train.json"
        ...
        for component in components:
            ...
            if backward_sentence and not all(char in string.punctuation for char in backward_sentence):
               ...
               if not exists:
                   ...
                   markers.append(copy.copy(marker_dict))

#print(ent)
#print(unique_chars)

output_json_filename = f"result_for_new_dataset_train.json"  # Change the output file name as needed
